...
module.exports = async (req, res) => {
    try {
        ...
        const  {_id,name, rectoQuestion, rectoAnswer, versoQuestion, versoAnswer , label} = req.body;
        ...
        { //if user can edit this card
            ...
            const card = await CardController.updateCard(_id,name,rectoQuestion, rectoAnswer, versoQuestion, versoAnswer,labelObject._id);
